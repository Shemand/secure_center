...
def init_table_Devices(metadata):
    return Table('Devices', metadata,
                 ...
                 Column('Crypto_Gateways_id', Integer, ForeignKey('Crypto_Gateways.id'), nullable=False),
                 Column('Structures_id', Integer, ForeignKey('Structures.id'), nullable=False),
                 Column('type', Integer, nullable=False),
                 Column('comment', Text)
                 )

def init_table_Statistics(metadata):
    return Table('Statistics', metadata,
                 Column('id', Integer, primary_key=True, autoincrement=True),
                 Column('Structures_id', Integer, ForeignKey('Structures.id'), nullable=False),
                 Column('all', Integer, nullable=False),
                 Column('quantity_of_disabled_computers', Integer, nullable=False),
                 Column('quantity_ARMs', Integer, nullable=False),
                 Column('quantity_servers', Integer, nullable=False),
                 Column('kaspersky_right', Integer, nullable=False),
                 Column('kaspersky_wrong', Integer, nullable=False),
                 Column('kaspersky_percent_right', Integer, nullable=False),
                 Column('computers_on_windows', Integer, nullable=False),
                 Column('ARMs_on_windows', Integer, nullable=False),
                 Column('servers_on_windows', Integer, nullable=False),
                 Column('ARMs_with_dallas', Integer, nullable=False),
                 Column('ARMs_without_dallas', Integer, nullable=False, default=0),
                 Column('dallas_percent_right', Integer, nullable=False, default=0),
                 Column('computers_on_linux', Integer, nullable=False),
                 Column('ARMs_on_linux', Integer, nullable=False),
                 Column('servers_on_linux', Integer, nullable=False),
                 Column('computers_on_puppet', Integer, nullable=False),
                 Column('puppet_percent_right', Integer, nullable=False),
                 Column('ARMs_unknown_os', Integer, nullable=False),
                 Column('number_of_update', Integer, nullable=False, default=1),
                 Column('created', DateTime, nullable=False, default=datetime.now())
                 )
